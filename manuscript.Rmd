...
author:
  - Stefan Gehrig^[Berlin, Germany; *stefan-gehrig@t-online.de*]
...
abstract: "Microcredit promotes financial inclusion for low-income entrepreneurs and households. Group lending -- a popular lending model, where the responsibility of repayment is shared in a borrower collective -- faces mixed success and its adoption is declining. Scholars have argued that the public good nature of the group loan gives rise to cooperative dilemmas and hinges on social capital among group members. In a cross-country analysis of a micro-lender database using Bayesian hierarchical models to account for variation between countries and culturally related clusters of countries, we examine how societal norms cooperation, specifically attitudes toward free-riding, are associated with microfinance loan repayment under different degrees of group lending. Analyzing more than 500 microfinance institutions across 57 countries, we find that stronger anti-free-riding norms correspond to lower delinquency rates, primarily for lenders with significant group loan portfolios. The findings are robust to multiple alternative specifications and hold conditional on many previously discussed predictors of microloan repayment from the literature. They highlight the potential relevance of social norms and expectations prevailing in society for microloan contract design and group‐based financial development initiatives more broadly."
output:
...
The Bayesian hierarchical models include varying intercepts for cultural clusters as a way to adjust for shared cultural ancestry among contemporary nations [@bromham_parasites_2018; @eff_weight_2008; @claessens_cross-national_2023]. Equivalent approaches have been used in previous cross-country research [@ruck_cultural_2020]. Broadly speaking, the clusters result from the combination of language relatedness data [@hammarstrom_glottolog_2020] with language speaker data [@eberhard_ethnologue_2018].
...
corrm_wevs %>%
  kable(format = "latex", booktab = TRUE,
        ...
        caption = "Correlation matrix of each pair of the items that were used for measuring cooperative norms.") %>%
