...
abstract: "Microcredit promotes financial inclusion for low-income entrepreneurs and households. Group lending, a popular approach, faces mixed success and declining adoption. It has been argued that the group loan's public goods nature gives rise to cooperative dilemmas and requires social capital. Using Bayesian hierarchical models to account for variation between countries and culturally related clusters of countries, we examine how cooperative norms in a society, specifically attitudes toward free-riding, are associated with microfinance loan repayment under different degrees of group lending. Analyzing more than 500 microfinance institutions across 57 countries, we find that stronger anti-free-riding norms correspond to lower delinquency rates, primarily in lenders with significant group loan portfolios. The findings are robust to multiple alternative specifications and hold conditional on many previously discussed predictors of microloan repayment. They highlight the potential relevance of prevailing norms and expectations in society for microloan contract design and group‐based financial development initiatives more broadly."
output:
